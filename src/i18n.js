(function initializeI18n(namespace) {
  ...
  const MESSAGES = {
    "zh-CN": {
      ...
      "status.saveFailed": "保存失败，请重试", "status.cleared": "未固定记录已清空，已固定消息已保留",
    ...
    en: {
      ...
      "status.saveFailed": "Could not save. Try again.", "status.cleared": "Unpinned history cleared; pinned messages kept",
